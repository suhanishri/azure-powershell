...
begin {
    try {
        ...
        $mapping = @{
            Update = 'Az.AlertsManagement.private\Set-AzPrometheusRuleGroup_Update';
            UpdateExpanded = 'Az.AlertsManagement.private\Set-AzPrometheusRuleGroup_UpdateExpanded';
        }
